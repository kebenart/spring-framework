...
the approach to testing controllers handling HTTP requests using the Spring MVC test.Test
framework. i.e. without running a Servlet container but relying on the Spring Framework
to invoke the annotated controllers. Just like with Spring MVC test.Test here there are two
